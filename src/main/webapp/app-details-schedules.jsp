        ...
        <div class="m-4 p-3 width-medium ">
            <div class="dashboard-content border-dashed p-3 m-4">
                ...
                <div class="schedules-content">
                    ...
                    <c:forEach items="${ UserPlan }" var="plan">
                        <c:if test="${weekday != plan[0]}">
                            <table class="table">
                                ...
                                <c:forEach items="${ UserPlan }" var="subplan">
                                    <c:if test="${plan[0] == subplan[0]}">
                                        <tr class="d-flex">
                                            <td class="col-2">${subplan[1]}</td>
                                            <td class="col-7">${subplan[2]}</td>
                                            <td class="col-1 center">
                                                <a href="/VerificationRecipeFromPlanServlet?plan_id=${plan_id}&&recipe_id=${subplan[4]}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                            </td>
