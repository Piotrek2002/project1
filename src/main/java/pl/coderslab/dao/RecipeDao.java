...
public class RecipeDao {
    ...
    private static final String DELETE_RECIPE_PLAN_QUERY = "delete from recipe_plan where recipe_id=? and plan_id=?;";
    ...
    private static final String USER_RECIPES_COUNT = "SELECT COUNT(*) FROM recipe WHERE admin_id = ?;";
    ...
    public Recipe create(Recipe recipe) {
        try (Connection connection = DbUtil.getConnection();
            ...
            insertStm.setString(6, recipe.getPreparationTime());
    ...
    public void deletefromplan(Integer recipeId,Integer planId) {
        try (Connection connection = DbUtil.getConnection();
    ...
    public int countUserRecipes(int userID) {
        ...
        try (Connection connection = DbUtil.getConnection();
             PreparedStatement statement = connection.prepareStatement(USER_RECIPES_COUNT)){
            ...
            if (resultSet.next()) {
                ...
                throw new Exception("Cannot count users");
            }
