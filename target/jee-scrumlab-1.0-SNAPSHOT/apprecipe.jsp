                    ...
                    <c:forEach items="${recipes}" var="recipe">
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="/VerificationRecipeServlet?id=${recipe.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                <a href="/app/recipe/details?id=${recipe.id}" class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                                <a href="/EditRecipeServlet?id=${recipe.id}" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                            </td>
                        </tr>
                        </c:forEach>
                    </tbody>
